...
pub fn add_rules(t: &mut ThemeBuilder, p: Palette) {
    workspace_colors(t, &p);
    syntax_highlighting(t, &p);
}

fn workspace_colors(t: &mut ThemeBuilder, p: &Palette) {
    t.w(["activityBar.activeBorder"], p.foreground());
    t.w(["activityBar.background"], p.greyscale(-1));
    t.w(["activityBar.foreground"], p.foreground());
    t.w(["activityBar.inactiveForeground"], p.greyscale(4));
    t.w(["activityBarBadge.background"], p.blue());
    t.w(["activityBarBadge.foreground"], p.greyscale(0));
    t.w(["badge.background"], p.greyscale(3));
    t.w(["badge.foreground"], p.foreground());
    t.w(["button.background"], p.blue());
    t.w(["button.foreground"], p.greyscale(0));
    t.w(["button.hoverBackground"], p.foreground());
    t.w(["checkbox.background"], p.greyscale(-2));
    t.w(["checkbox.border"], p.greyscale(2));
    t.w(["debugIcon.breakpointForeground"], p.red());
    t.w(
        ["diffEditor.insertedTextBackground"],
        p.green().adjust_lightness(DIFF_BG_LIGHTNESS).with_alpha(0x33),
    );
    t.w(
        ["diffEditor.removedTextBackground"],
        p.red().adjust_lightness(DIFF_BG_LIGHTNESS).with_alpha(0x33),
    );
    t.w(["dropdown.border"], p.greyscale(2));
    t.w(["dropdown.foreground"], p.foreground());
    t.w(["editor.background"], p.greyscale(0));
    t.w(["editor.foldBackground"], p.blue().with_alpha(0x22));
    t.w(["editor.foreground", "foreground"], p.foreground());
    t.w(["editor.hoverHighlightBackground"], p.greyscale(2));
    t.w(["editor.lineHighlightBackground"], p.greyscale(-1));
    t.w(["editor.rangeHighlightBackground"], p.blue().with_alpha(0x22));
    ...
    t.w(
        ...
        p.green_intense().with_alpha(0x86),
    );
    t.w(
        // Write access
        [
    ...
    t.w(
        ...
        p.yellow().with_alpha(0x99),
    );
    t.w(["editor.findMatchHighlightBackground"], p.yellow().with_alpha(0x44));
    // Highlighting End

    t.w(["editorCursor.foreground"], p.bright_foreground());
    t.w(["editorError.foreground"], p.red());
    t.w(["editorGroup.dropBackground"], p.blue().with_alpha(0x22));
    ...
    t.w(
        ...
        p.green().adjust_lightness(OVERVIEW_RULER_LIGHTNESS),
    );
    t.w(["editorOverviewRuler.border"], p.greyscale(3));
    t.w(
        ["editorOverviewRuler.deletedForeground"],
        p.red().adjust_lightness(OVERVIEW_RULER_LIGHTNESS),
    );
    t.w(
    ...
    t.w(
        ...
        p.turquoise().adjust_lightness(OVERVIEW_RULER_LIGHTNESS),
    );
    t.w(
        ["editorOverviewRuler.modifiedForeground"],
        p.blue().adjust_lightness(OVERVIEW_RULER_LIGHTNESS),
    );
    t.w(
        ["editorOverviewRuler.rangeHighlightForeground"],
        p.blue().adjust_lightness(OVERVIEW_RULER_LIGHTNESS).with_alpha(0x33),
    );
    t.w(["editorWarning.foreground"], p.orange());
    t.w(["editorWidget.background"], p.greyscale(-1));
    t.w(["editorWidget.border"], p.greyscale(2));
    t.w(
        ["errorLens.errorBackground"],
        p.red().adjust_lightness(ERROR_LENS_BACKGROUND_LIGHTNESS).with_alpha(0x33),
    );
    t.w(["errorLens.errorForeground"], p.red().adjust_lightness(ERROR_LENS_FOREGROUND_LIGHTNESS));
    t.w(
        ["errorLens.warningBackground"],
        p.orange().adjust_lightness(ERROR_LENS_BACKGROUND_LIGHTNESS).with_alpha(0x33),
    );
    t.w(
        ["errorLens.warningForeground"],
        p.orange().adjust_lightness(ERROR_LENS_FOREGROUND_LIGHTNESS),
    );
    t.w(
        ["errorLens.infoBackground"],
        p.turquoise().adjust_lightness(ERROR_LENS_BACKGROUND_LIGHTNESS).with_alpha(0x33),
    );
    t.w(
        ["errorLens.infoForeground"],
        p.turquoise().adjust_lightness(ERROR_LENS_FOREGROUND_LIGHTNESS),
    );
    t.w(
        ["errorLens.hintBackground"],
        p.green().adjust_lightness(ERROR_LENS_BACKGROUND_LIGHTNESS).with_alpha(0x33),
    );
    t.w(["errorLens.hintForeground"], p.green().adjust_lightness(ERROR_LENS_FOREGROUND_LIGHTNESS));
    t.w(["focusBorder"], p.greyscale(3));
    t.w(["gitDecoration.ignoredResourceForeground"], p.greyscale(4));
    t.w(
        ["gitDecoration.modifiedResourceForeground"],
        p.blue().adjust_lightness(1).adjust_lightness(GIT_DECORATION_LIGHTNESS),
    );
    t.w(
        ["gitDecoration.untrackedResourceForeground"],
        p.green().adjust_lightness(GIT_DECORATION_LIGHTNESS),
    );
    t.w(["input.background"], p.greyscale(-2));
    t.w(["input.border"], p.greyscale(2));
    t.w(["input.foreground"], p.foreground());
    t.w(["input.placeholderForeground"], p.greyscale(4));
    t.w(["list.activeSelectionBackground"], p.greyscale(2));
    t.w(["list.activeSelectionForeground"], p.foreground());
    t.w(["list.errorForeground"], p.red());
    t.w(["list.focusBackground"], p.greyscale(2));
    t.w(["list.highlightForeground"], p.blue().adjust_lightness(2));
    t.w(["list.hoverBackground"], p.greyscale(0));
    t.w(["list.inactiveSelectionBackground"], p.greyscale(1));
    t.w(["list.warningForeground"], p.orange());
    t.w(["minimap.errorHighlight"], p.red().adjust_lightness(MINIMAP_LIGHTNESS));
    t.w(["minimap.warningHighlight"], p.orange().adjust_lightness(MINIMAP_LIGHTNESS));
    t.w(["panel.background"], p.greyscale(1));
    t.w(["panel.border"], p.greyscale(3));
    t.w(["panelTitle.activeForeground"], p.foreground());
    t.w(["peekView.border"], p.greyscale(4));
    t.w(["peekViewEditor.background"], p.greyscale(0));
    t.w(["peekViewEditor.matchHighlightBackground"], p.blue().with_alpha(0x66));
    t.w(["peekViewResult.background"], p.greyscale(-1));
    t.w(["peekViewResult.fileForeground"], p.foreground());
    t.w(["peekViewResult.lineForeground"], p.foreground().with_alpha(0x99));
    t.w(["peekViewResult.matchHighlightBackground"], p.blue().with_alpha(0x44));
    t.w(["peekViewResult.selectionBackground"], p.greyscale(2));
    t.w(["peekViewResult.selectionForeground"], p.foreground());
    t.w(["peekViewTitle.background"], p.greyscale(-1));
    t.w(["peekViewTitleDescription.foreground"], p.blue());
    t.w(["peekViewTitleLabel.foreground"], p.bright_foreground());
    t.w(["progressBar.background"], p.blue());
    ...
    t.w(["settings.headerForeground"], p.bright_foreground());
    t.w(["settings.modifiedItemIndicator"], p.blue());
    t.w(["sideBar.background"], p.greyscale(-1));
    t.w(["sideBar.foreground"], p.foreground());
    t.w(["sideBarTitle.foreground"], p.bright_foreground());
    t.w(
        ["statusBar.background", "statusBar.debuggingBackground", "statusBar.noFolderBackground"],
        p.greyscale(-2),
    );
    t.w(["statusBar.foreground"], p.foreground().adjust_lightness(STATUS_BAR_LIGHTNESS));
    t.w(["statusBar.debuggingForeground"], p.orange().adjust_lightness(STATUS_BAR_LIGHTNESS));
    ...
    t.w(["tab.activeForeground"], p.foreground());
    ...
    t.w(["terminal.ansiBlue"], p.blue().adjust_lightness(TERMINAL_ANSI_LIGHTNESS));
    t.w(["terminal.ansiBrightBlack"], p.greyscale(5));
    t.w(["terminal.ansiBrightBlue"], p.blue().adjust_lightness(TERMINAL_ANSI_BRIGHT_LIGHTNESS));
    t.w(["terminal.ansiBrightCyan"], p.cyan().adjust_lightness(TERMINAL_ANSI_BRIGHT_LIGHTNESS));
    t.w(["terminal.ansiBrightGreen"], p.green().adjust_lightness(TERMINAL_ANSI_BRIGHT_LIGHTNESS));
    t.w(
        ["terminal.ansiBrightMagenta"],
        p.purple().adjust_lightness(TERMINAL_ANSI_BRIGHT_LIGHTNESS),
    );
    t.w(["terminal.ansiBrightRed"], p.red().adjust_lightness(TERMINAL_ANSI_BRIGHT_LIGHTNESS));
    t.w(["terminal.ansiBrightWhite"], p.bright_foreground());
    t.w(["terminal.ansiBrightYellow"], p.yellow().adjust_lightness(TERMINAL_ANSI_BRIGHT_LIGHTNESS));
    t.w(["terminal.ansiCyan"], p.cyan().adjust_lightness(TERMINAL_ANSI_LIGHTNESS));
    t.w(["terminal.ansiGreen"], p.green().adjust_lightness(TERMINAL_ANSI_LIGHTNESS));
    t.w(["terminal.ansiMagenta"], p.purple().adjust_lightness(TERMINAL_ANSI_LIGHTNESS));
    t.w(["terminal.ansiRed"], p.red().adjust_lightness(TERMINAL_ANSI_LIGHTNESS));
    t.w(["terminal.ansiWhite"], p.foreground());
    t.w(["terminal.ansiYellow"], p.yellow().adjust_lightness(TERMINAL_ANSI_LIGHTNESS));
    t.w(["terminal.foreground"], p.foreground());
    t.w(["terminalCursor.foreground"], p.bright_foreground());
    t.w(["textPreformat.foreground"], p.foreground()); // inline code in e.g. Settings page
    t.w(["titleBar.activeBackground"], p.greyscale(-1));
    t.w(["titleBar.activeForeground"], p.foreground());
    ...
    t.w(["tab.activeBackground"], p.functions().with_chroma(0.1).with_alpha(0x22))
}
...
fn syntax_highlighting(t: &mut ThemeBuilder, p: &Palette) {
    ...
    t.a([s("number"), tm("constant.numeric"), tm("keyword.other.unit")], p.numbers());
    ...
    t.a(
        ...
        (p.accent(), FontStyle::Italic),
    );

    t.a([s("escapeSequence"), tm("constant.character.escape")], p.blue());
    ...
    t.a(
        [
            ...
            tm("meta.brace.round.ts"),
        ],
        (p.operators(), FontStyle::Clear),
    );
    ...
    t.a(
        ...
        p.green().adjust_lightness(DIFF_FG_LIGHTNESS),
    );
    t.a(
        [tm("markup.deleted"), tm("punctuation.definition.deleted.diff")],
        p.red().adjust_lightness(DIFF_FG_LIGHTNESS),
    );
    t.a([tm("markup.changed")], p.orange().adjust_lightness(DIFF_FG_LIGHTNESS));

    t.a([tm("punctuation.definition.range.diff"), tm("meta.diff.range")], p.blue());
    t.a(
        [
    ...
    t.a(
        ...
        (p.bright_foreground(), FontStyle::Bold),
    );
    t.a(
    ...
    // t.a([s("*.public.declaration")], p.functions());

    t.a([s("unresolvedReference")], (p.red().adjust_lightness(-1), FontStyle::Underline));

    t.a([s("magit-ref-name")], (p.cyan().adjust_lightness(1), FontStyle::Bold));
    t.a([s("magit-remote-ref-name")], (p.green().adjust_lightness(-2), FontStyle::Bold));
    t.a([tm("magit.header")], (p.yellow().adjust_lightness(2), FontStyle::Bold));
    t.a([tm("magit.subheader")], FontStyle::Bold);
    t.a([tm("magit.entity")], p.greyscale(5));

    // Over 50 characters, the recommended limit.
    t.a([tm("invalid.deprecated.line-too-long.git-commit")], p.orange());

    // Over 72 characters, the hard limit.
    t.a([tm("invalid.illegal.line-too-long.git-commit")], p.red());
